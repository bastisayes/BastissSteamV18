...
<button class="btn btn-primary" onclick="create14LotesCode()">Crear codigo con 59 lotes</button>
<button class="btn btn-ghost" style="border:1px solid #ff9800;color:#ff9800" onclick="createPruebaCode()">Codigo de prueba (10 min, 59 lotes)</button>
